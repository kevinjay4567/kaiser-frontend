...
export function LoginPage() {
  ...
  return (
    <div
      className={`relative min-h-screen overflow-hidden transition-colors duration-300 ${isDarkMode ? "bg-zinc-950 text-white" : "bg-zinc-100 text-zinc-900"}`}
    >
      ...
      <div className="relative flex min-h-screen items-center justify-center p-4 md:p-8">
        ...
        <div className="relative z-10 flex w-full max-w-md flex-col items-center">
          ...
          <div className="w-full mx-200 rounded-2xl border border-zinc-300 dark:border-zinc-800 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl p-4 shadow-2xl">
          ...
          <div className="mt-12 text-center">
            <p className="mb-4 text-sm text-zinc-500 dark:text-zinc-400">
              Unete a mas de{" "}
              <span
                className={`${isDarkMode ? "text-zinc-400 font-bold" : "text-zinc-600 font-bold"}`}
              >
                2500
              </span>{" "}
...
const avatars = [
  ...
  `${API_URL}/resources/images/galleta-trabajo.jpeg`,
];
